...
public class Estadisticas  implements java.io.Serializable {
    ...
    public Estadisticas(EstadisticasId id, Jugadores jugadores, Float puntosPorPartido, Float asistenciasPorPartido, Float taponesPorPartido, Float rebotesPorPartido) {
       this.id = id;
       this.jugadores = jugadores;
